...
function Paper() {
  return (
    <>
      <h2 className=" md:item-none md:justify-left p-2 flex pl-5 font-bold  text-xl">
        Detail of the Paper
      </h2>
      <div className=" h-100  flex pl-5 ">
        <form className=" border-2 border-gray-600 p-6">
          <div>
            ...
            <input
              className="border-2 border-gray-500  m-2 w-64 rounded text-lg"
              type="text"
              name="paper title"
            ></input>
          </div>
          <div>
            ...
            <input
              className="border-2 border-gray-500 rounded m-2 w-64 "
              type="text"
              name="Published By"
            ></input>
          </div>
          <div>
            ...
            <input
              className="  roundedborder-2 border-gray-500 m-2 w-64 "
              type="date"
              name="Published Date"
            ></input>
          </div>
          ...
          <div>
            ...
            <input
              className="border-2  rounded border-gray-500 m-2 w-64 "
              type="text"
              name="link"
            ></input>
          </div>
          <div>
            ...
            <input
              className="border-2 border-gray-500 m-2 w-64  rounded"
              type="text"
              name="pdf"
            ></input>
          </div>
          <div className="pl-72 pt-2">
            <button className="bg-blue-900 rounded px-6 text-white ">
              Save
            </button>
          </div>
        </form>
